/*
Exercise - Challenge activity to discover and implement a method call

Math Class - Implement a method of the Math class that returns the larger of two numbers.
...
Verify that your application writes the following output:
